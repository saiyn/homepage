...
![probe_1](http://omp8s6jms.bkt.clouddn.com/image/git/probe_1.png)

上面提示我们可以执行`perf record -e probe:xxx`命令来检测刚才上面设置的event, 执行结果如下:

![probe_2](http://omp8s6jms.bkt.clouddn.com/image/git/probe_2.png)
...
![probe_3](http://omp8s6jms.bkt.clouddn.com/image/git/probe_3.png)
...
![probe_4](http://omp8s6jms.bkt.clouddn.com/image/git/probe_4.png)

单步跟踪进去，最终在下面代码段锁定了问题:

![probe_5](http://omp8s6jms.bkt.clouddn.com/image/git/probe_5.png)

原来是bzImage的build id 和 vmlinux 的build id 不一致导致的，因为我中间操作的问题，导致这两个文件不是同一次编译出来的。

问题解决后，执行命令如下:

![probe_6](http://omp8s6jms.bkt.clouddn.com/image/git/probe_6.png)
...
![probe_7](http://omp8s6jms.bkt.clouddn.com/image/git/probe_7.png)
...
![perf_top_1](http://omp8s6jms.bkt.clouddn.com/image/git/perf_top_1.png)
...
![perf_top_2](http://omp8s6jms.bkt.clouddn.com/image/git/perf_top_2.png)
...
![top_3](http://omp8s6jms.bkt.clouddn.com/image/git/perf_top_3.png)
