...
![diy_0](http://omp8s6jms.bkt.clouddn.com/image/git/diy_0.png)

<br />

假设我们的进程中只有两个线程，每个线程调用malloc申请的地址都会在本线程中被free掉，那么我们就可以以线程为单位，统计一段时间内，每个线程的malloc和free次数，如果free的次数明显少于malloc次数，说明存在内存泄漏。
...
![diy_1](http://omp8s6jms.bkt.clouddn.com/image/git/diy_1.png)
