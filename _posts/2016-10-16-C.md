...
LIBRARY_PATH=/home/lib:$LD_LIBRARY_PATH`以及`eport PATH=/home/bin:$LD_LIBRARY_PATH`。
 ...
 的问题，很多人也给了解决办法，但是很多方法不是没有用就是留了很多坑。
...
切换分支
 ...
 ，然后有一个贴出了一大段命令，如何解决这个问题。
SECUER_SIG_ENFORCE`kermel config has been enabled.
