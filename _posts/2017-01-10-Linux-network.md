...
今天测试程序性能时发现，程序运行后cpu占用特别高，很快飙升并稳定在107%左右。使用perf性能工具分析后，很快定位到时程序一处select函数调用最占用了
大部分CPU时间。
...
![wrk_001](https://raw.githubusercontent.com/saiyn/homepage/gh-pages/images/wrk_001.png)
