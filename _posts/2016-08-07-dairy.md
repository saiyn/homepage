...
![dairy_101](http://omp8s6jms.bkt.clouddn.com/image/git/dairy_101.png)
...
1. 执行`lsb_release -a`命令查看当前ubuntu版本信息。

![dairy_1oo](http://omp8s6jms.bkt.clouddn.com/image/git/dairy_100.png)
...
不过还要在配置文件最后添加如下配置行来配合chroot_local_user功能：
