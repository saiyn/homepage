...
```
	echo "using gcc : 9.2.0 : aarch64-poky-linux-g++ : <compileflags>\"-I/opt/toolchain/xxx/include --sysroot=/opt/toolchain/xxx/rootfs\" ;" > $HOME/user-config.jam

```

然后执行`./b2 toolset=gcc-9.2.0` 进行编译。
