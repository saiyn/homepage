...
#ALL in IOT in industry
<br />

* [CANTT](https://medium.com/@mikael.brorsson/broadcasting-a-temperature-sensor-over-can-bus-mqtt-style-75ad6fa33262)
一个实现了我思考实现的技术方案。简单的说就是MQTT ON CAN
...
对于c出生的程序员来说，这系列文章非常值得学习，通过对比学习，收获很大。
...
左值、右值、左值引用、右值引用，这篇文章对于理解C++的右值特性在构造函数中的运用很有启发，同时里面包括了std::forword等特性使用。

![nice_blog_0](http://omp8s6jms.bkt.clouddn.com/image/git/nice_blog_0.png)

这个主页包含了大量的c++方面的技术文章，`mark!!!!`

* [sougou workflow 技术解析](https://www.zhihu.com/people/liyingxin1412)
workflow是搜狗刚刚开源的c++服务器引擎
...
* [Introduction to Elasticsearch](https://blog.minimum.se/2019/04/08/elastic-search-introduction.html)

* [The Complete Guid to ELK](https://logz.io/learn/complete-guide-elk-stack/#intro)
...
[linux命令大全](https://linuxcommandlibrary.com/basic/oneliners.html)
...
* [automake](https://robots.thoughtbot.com/the-magic-behind-configure-make-make-install)
...
* [zlib、libzip、gzip说明](https://www.hitoy.org/zlib-gzip-zip.html)

* [论文检索](https://www.mdpi.com/)

* [华硕路由器安装软件](https://www.zcq100.com/install-entware-on-arm-device/)
